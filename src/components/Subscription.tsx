...
import { POST } from "@/api/email";
import { useState } from "react";

export const Subscription = () => {
  const [email, setemail] = useState('')
  const sendEmailAction = POST.bind(null, email)
      ...
      <div className="p-8 md:p-12 lg:px-16 lg:py-32">
        <div className="mx-auto max-w-screen-lg text-center">
          ...
          <p className="hidden text-white sm:mt-4 sm:block">
            ...
            treasure trove of Web Dev mastery, Cloud Architect insights, and AI
            innovation - your roadmap to success in the ever-evolving tech
            landscape!
          </p>
        </div>

        <div className="mx-auto mt-8 max-w-xl">
          <form action={sendEmailAction} className="sm:flex sm:gap-4">
